...
{
    public class SpendMainAccountDirectTransferExchangePartyCompanyDomainService : ITreasuryActionDomainService
    {
        ...
        public SpendMainAccountDirectTransferExchangePartyCompanyDomainService(
        ...
        private async Task<TreasuryAction> GetByIdWithDetail(int id)
        {
            ...
            await _treasuryActionRepository.EnsurePropertyLoadedAsync(teasuryAction, x => x.MainAccountCompany);
