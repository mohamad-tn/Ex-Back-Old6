...
namespace Bwr.Exchange.ExchangeCurrencies.Services.Implements
{
    public  class ClientExchangeCurrencyService : IExchangeCurrencyDomainService
    {
        ...
        public ClientExchangeCurrencyService(IRepository<ExchangeCurrency> exchangeCurrencyRepository, IRepository<ExchangePrice> exchangePriceRepository, IRepository<Treasury> treasuryRepository, IUnitOfWorkManager unitOfWorkManager)
        {
